...
SEVERITY_OPTIONS = {
    "CRITICAL — service down / major impact": "Critical",
    "HIGH — significant degradation": "High",
    "MEDIUM — moderate degradation": "Medium",
    "LOW — minor / cosmetic": "Low",
}

PRIORITY_COLORS = {
    "Critical": (RED, RED_SOFT),
    "High": (AMBER, AMBER_SOFT),
    "Medium": (BLUE, BLUE_SOFT),
...
# =========================================================================
# Session state — incident records + baseline seed numbers
# =========================================================================
if "page" not in st.session_state:
    st.session_state.page = "dashboard"

if "incidents" not in st.session_state:
    st.session_state.incidents = []  # each: dict, see fields below

if "baseline" not in st.session_state:
    # Starting demo values so the dashboard isn't empty on first load.
    # Real incidents analyzed in this session are added on top of these.
    st.session_state.baseline = {"active": 1, "resolved": 7, "pending": 1, "runs_total": 8, "runs_success": 8}
            ...
            for label in ["Critical", "High", "Medium", "Low"]:
                ...
                <div class="sev-row">
                    <div style="display:flex; justify-content:space-between; font-size:0.85rem;">
                        <span>{label} priority</span><span class="mono">{count} ({pct}%)</span>
                    </div>
...
# =========================================================================
    ...
    with st.container():
        ...
        with col_a:
            ...
            st.caption("＊ Critical severity automatically flags the incident for human manager approval before applying resolution plans.")
        with col_b:
            st.markdown(
                f"""
